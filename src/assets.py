wheel_friction_coefficients = {
    "road": {
        ...
        "snow_hard_packed": {"min": 0.2, "max": 0.3},
        "ice": {"min": 0.05, "max": 0.2, "notes": "Very low friction.", "alt_range": [0.07, 0.1]},
        "gravel": {"min": 0.55, "max": 0.6, "notes": "Dry gravel"},
        "earth_road_dry": {"min": 0.65, "max": 0.68},
        "earth_road_wet": {"min": 0.4, "max": 0.5},
        "loose_gravel": {
            "min": 0.35,
    ...
    "sand": {
        "solid_sand": {"rolling_friction_min": 0.04, "rolling_friction_max": 0.08},
        "loose_sand": {
